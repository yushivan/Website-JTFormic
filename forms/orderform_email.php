...
//pengirim
$mail->setFrom('noreply@jtformic.com',$email);
$mail->addAddress('rendi@jtformic.com');     //Add a recipient

//Content
$mail->isHTML(true);                                  //Set email format to HTML
$mail->Subject = 'Website Package - '. $package;
$mail->Body    = '<div style="width: 750px; margin: 0 auto;">
        ...
        <h1 style="color: white;">Website Order Form</h1>        
        </div>
        ...
        <tr>
        <td style="width: 28%; padding: .5rem; color: #555;">Description</td>
        <td style="width: 2%;">:</td>
        <td style="width: 70%; padding: .5rem; font-weight: bold;">'. $description .' Hour</td>
        </tr>
        </tbody>
        </table>
